...
// Only allow image file types - NO PDFs, Word docs, etc.
...
const bannerUpload = multer({
  ...
  fileFilter: function (req, file, cb) {
    ...
    cb(
      new Error(
        "Only image files are allowed (jpeg, jpg, png, gif, webp). PDFs, Word documents, and other file types are not accepted."
      )
    );
  },
});
