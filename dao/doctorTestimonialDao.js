...
const TABLE_NAME = "gcs_doctor_testimonials";

const createDoctorTestimonial = async (testimonialData) => {
  const {
    name,
    video_url,
    display_order,
...
const getAllDoctorTestimonials = async (includeInactive = false) => {
...
const getDoctorTestimonialById = async (id) => {
...
const updateDoctorTestimonial = async (id, data) => {
...
const deleteDoctorTestimonial = async (id) => {
...
const updateDoctorTestimonialOrder = async (orderedItems) => {
